...
-- Atajos para VimTeX con nuevo líder
vim.api.nvim_set_keymap('n', '\\v', ':VimtexView<CR>', { noremap = true, silent = true })    -- Ver el PDF
vim.api.nvim_set_keymap('n', '\\s', ':VimtexStop<CR>', { noremap = true, silent = true })    -- Detener la compilación
vim.api.nvim_set_keymap('n', '\\o', ':VimtexOutline<CR>', { noremap = true, silent = true }) -- Ver el índice

-- Sincronización inversa con SumatraPDF (en la tecla F8)
vim.api.nvim_set_keymap('n', '<F8>', ':VimtexView<CR>', { noremap = true, silent = true })
-- Mapeo de f7 para abrir el TOC
